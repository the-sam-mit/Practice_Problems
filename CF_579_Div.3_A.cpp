...
int main(){
    testcase(t){
        ...
        rep(i,0,n-2){
            if(a[(curr+i)%n]+1 != a[(curr+1+i)%n]) flag=false;
            // cout<<a[(curr+i)%n] << a[(curr+1+i)%n]<<endl;
        }
        if(flag==true){
            cout<<"YES\n";
            continue;
        ...
        flag = true;
        rep(i,0,n-2){
            if(a[(curr-i+n)%n]+1 != a[(curr-1-i+n)%n]) flag=false;
            // cout<<a[(curr-i+n)%n]+1 <<"= "<< a[(curr-1-i+n)%n]<<endl;
        }
        if(flag==true){
            cout<<"YES\n";
            continue;
