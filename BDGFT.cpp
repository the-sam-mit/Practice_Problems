...
//This implementation cleverly calculates all the optimum lengths for which the condition will hold and then by brute force, checks for all substrings of that particular length. 